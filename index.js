...
(function($PS) {
  ...
  var TeamB = (function () {
      ...
      TeamB.value = new TeamB();
      return TeamB;
  })();
  var SelectChange = (function () {
      function SelectChange(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SelectChange.create = function (value0) {
          return function (value1) {
              return new SelectChange(value0, value1);
          };
      };
      return SelectChange;
  })();
  var teamToOffset = function (v) {
      if (v instanceof TeamA) {
          return 0;
      };
      if (v instanceof TeamB) {
          return 5;
      };
      throw new Error("Failed pattern match at Main (line 67, column 16 - line 69, column 15): " + [ v.constructor.name ]);
  };
  var ranksByTeam = function (v) {
      if (v instanceof TeamA) {
          return function (v1) {
              return v1.teamARanks;
          };
      };
      if (v instanceof TeamB) {
          return function (v1) {
              return v1.teamBRanks;
          };
      };
      throw new Error("Failed pattern match at Main (line 72, column 15 - line 74, column 26): " + [ v.constructor.name ]);
  };
  var initialState = function (v) {
      return {
          teamARanks: Data_Array.replicate(5)(1),
          teamBRanks: Data_Array.replicate(5)(1)
      };
  };
  var idToTeamIx = function (id) {
      var numToTeam = function (v) {
          if (v === 0) {
              return TeamA.value;
          };
          return TeamB.value;
      };
      var idNum = Data_Maybe.fromJust()(Data_Int.fromString(id));
      return {
          team: numToTeam(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(idNum)(5)),
          ix: Data_Int.rem(idNum)(5)
      };
  };
  var idFromTeamIx = function (team) {
      return function (ix) {
          return Data_Show.show(Data_Show.showInt)(ix + teamToOffset(team) | 0);
      };
  };
  var selectRank = function (team) {
      return function (ix) {
          var toOption = function (ix1) {
              return function (label) {
                  return Halogen_HTML_Elements.option([ Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showInt)(ix1 + 1 | 0)) ])([ Halogen_HTML_Core.text(label) ]);
              };
          };
          return Halogen_HTML_Elements.select([ Halogen_HTML_Properties.classes([ "scoreboard__rank" ]), Halogen_HTML_Properties.id(idFromTeamIx(team)(ix)), Halogen_HTML_Events.onChange(Data_Function["const"](new SelectChange(team, ix))) ])(Data_Array.mapWithIndex(toOption)([ "Silver 1", "Silver 2", "silver 3", "Silver Elite", "Silver Elite Master", "Gold Nova 1", "Gold Nova 2", "Gold Nova 3", "Gold Nova Master", "Master Guardian 1", "Master Guardian 2", "Master Guardian Elite", "Distinguished Master Guardian", "Legendary Eagle", "Legendary Eagle Master", "Supreme Master First Class", "The Global Elite" ]));
      };
  };
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Web_HTML_HTMLDocument.toDocument)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window))))(function (document) {
              var nonElementParentNode = Web_DOM_Document.toNonElementParentNode(document);
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Web_DOM_NonElementParentNode.getElementById(idFromTeamIx(v.value0)(v.value1))(nonElementParentNode)))(function (mElement) {
                  var select = Data_Maybe.fromJust()(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Web_HTML_HTMLSelectElement.fromElement)(mElement));
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Data_Functor.map(Effect.functorEffect)((function (dictPartial) {
                      var $46 = Data_Maybe.fromJust();
                      return function ($47) {
                          return $46(Data_Int.fromString($47));
                      };
                  })())(Web_HTML_HTMLSelectElement.value(select))))(function (value) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                          if (v.value0 instanceof TeamA) {
                              var $27 = {};
                              for (var $28 in state) {
                              ...
                              $27.teamARanks = Data_Maybe.fromJust()(Data_Array.updateAt(v.value1)(value)(state.teamARanks));
                              return $27;
                          };
                          if (v.value0 instanceof TeamB) {
                              var $30 = {};
                              for (var $31 in state) {
                              ...
                              $30.teamBRanks = Data_Maybe.fromJust()(Data_Array.updateAt(v.value1)(value)(state.teamBRanks));
                              return $30;
                          };
                          throw new Error("Failed pattern match at Main (line 94, column 25 - line 96, column 108): " + [ v.value0.constructor.name ]);
                      });
                  });
              });
          });
  ...
  var genericTeam = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof TeamA) {
          return new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value);
      };
      if (x instanceof TeamB) {
          return new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value);
      };
      throw new Error("Failed pattern match at Main (line 47, column 1 - line 47, column 46): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var showTeam = new Data_Show.Show(Data_Show_Generic.genericShow(genericTeam)(Data_Show_Generic.genericShowSum(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "TeamA";
  })))(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "TeamB";
  })))));
  var render = function (ranks) {
      var rankSum = function (v) {
          if (v instanceof TeamA) {
              return Data_Newtype.ala()()()(Data_Monoid_Additive.Additive)(Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt)))(ranksByTeam(TeamA.value)(ranks));
          };
          if (v instanceof TeamB) {
              return Data_Newtype.ala()()()(Data_Monoid_Additive.Additive)(Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Monoid_Additive.monoidAdditive(Data_Semiring.semiringInt)))(ranksByTeam(TeamB.value)(ranks));
          };
          throw new Error("Failed pattern match at Main (line 124, column 15 - line 126, column 64): " + [ v.constructor.name ]);
      };
      var rankDiff = Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(rankSum(TeamA.value) - rankSum(TeamB.value) | 0);
      var rankAverage = function (team) {
          return Data_Int.toNumber(rankSum(team)) / 5.0;
      };
      var rankRatio = rankAverage(TeamA.value) / rankAverage(TeamB.value);
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "wrapper" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "scoreboard" ]) ])(Control_Bind.bind(Control_Bind.bindArray)([ TeamA.value, TeamB.value ])(function (team) {
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Control_Applicative.pure(Control_Applicative.applicativeArray)(Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text(Data_Show.show(showTeam)(team)) ])))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Control_Bind.bind(Control_Bind.bindArray)(Data_Enum.enumFromTo(Data_Enum.enumInt)(Data_Unfoldable1.unfoldable1Array)(0)(4))(function (ix) {
              return Control_Applicative.pure(Control_Applicative.applicativeArray)(selectRank(team)(ix));
          }))([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Rank sum: " + Data_Show.show(Data_Show.showInt)(rankSum(team))) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Rank average: " + Data_Number_Format.toStringWith(Data_Number_Format.precision(2))(rankAverage(team))) ]) ]));
      })), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "summary" ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Rank ratio (A/B): " + Data_Number_Format.toStringWith(Data_Number_Format.precision(3))(rankRatio)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Rank diff (abs(A-B)): " + Data_Show.show(Data_Show.showInt)(rankDiff)) ]) ]) ]);
  };
  var genericAction = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.value0, x.value1);
  }, function (x) {
      return new SelectChange(x.value0, x.value1);
  });
  var showAction = new Data_Show.Show(Data_Show_Generic.genericShow(genericAction)(Data_Show_Generic.genericShowConstructor(Data_Show_Generic.genericShowArgsProduct(Data_Show_Generic.genericShowArgsArgument(showTeam))(Data_Show_Generic.genericShowArgsArgument(Data_Show.showInt)))(new Data_Symbol.IsSymbol(function () {
      return "SelectChange";
  }))));
  ...
  exports["TeamA"] = TeamA;
  exports["TeamB"] = TeamB;
  exports["idFromTeamIx"] = idFromTeamIx;
  exports["idToTeamIx"] = idToTeamIx;
  exports["teamToOffset"] = teamToOffset;
  exports["ranksByTeam"] = ranksByTeam;
  exports["component"] = component;
  exports["initialState"] = initialState;
  exports["handleAction"] = handleAction;
  exports["render"] = render;
  exports["selectRank"] = selectRank;
  exports["genericAction"] = genericAction;
  exports["genericTeam"] = genericTeam;
